...
TEST_SENSOR_FIXTURE_FILE = f"{HOMES}/sensor-example.yaml"
...
@pytest.mark.parametrize(("config_yaml_fixture"), [(f"{HOMES}/hvac-example.yaml")])
...
@pytest.mark.parametrize(
    ("config_yaml_fixture"), [(f"{HOMES}/smart-plug-example.yaml")]
)
