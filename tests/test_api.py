"""Tests for Synthetic Home api."""
import asyncio

import aiohttp
from custom_components.synthetic_home.api import (
    SyntheticHomeApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = SyntheticHomeApiClient("test", "test", async_get_clientsession(hass))
